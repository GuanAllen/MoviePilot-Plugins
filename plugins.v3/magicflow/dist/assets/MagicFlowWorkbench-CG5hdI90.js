...
const _hoisted_8 = { class: "magicflow-mobile-toolbar" };
const _hoisted_9 = {
  key: 1,
  class: "magicflow-mobile-current"
};
const _hoisted_10 = { class: "magicflow-layout" };
const _hoisted_11 = { class: "magicflow-task-rail__head" };
const _hoisted_12 = { class: "magicflow-task-list" };
const _hoisted_13 = ["aria-pressed", "onClick"];
const _hoisted_14 = { class: "magicflow-task-item__title" };
const _hoisted_15 = { class: "magicflow-task-item__meta" };
const _hoisted_16 = {
  key: 0,
  class: "magicflow-workspace"
};
const _hoisted_17 = { class: "magicflow-task-head" };
const _hoisted_18 = { class: "magicflow-task-head__identity" };
const _hoisted_19 = ["src"];
const _hoisted_20 = { class: "magicflow-task-head__body" };
const _hoisted_21 = { class: "magicflow-task-head__title" };
const _hoisted_22 = { class: "magicflow-task-head__actions" };
const _hoisted_23 = {
  class: "magicflow-tabs",
  role: "tablist"
};
const _hoisted_24 = ["aria-selected", "onClick"];
const _hoisted_25 = { class: "magicflow-stat-grid" };
const _hoisted_26 = { class: "magicflow-overview-grid" };
const _hoisted_27 = { class: "magicflow-panel__head" };
const _hoisted_28 = { class: "magicflow-facts" };
const _hoisted_29 = { class: "magicflow-panel__head" };
const _hoisted_30 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_31 = { class: "magicflow-run-summary" };
const _hoisted_32 = { class: "magicflow-panel__head" };
const _hoisted_33 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_34 = { class: "magicflow-flow__chain" };
const _hoisted_35 = { class: "magicflow-flow__dot" };
const _hoisted_36 = { class: "magicflow-flow__label" };
const _hoisted_37 = { class: "magicflow-panel__head" };
const _hoisted_38 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_39 = {
  key: 0,
  class: "magicflow-reasons"
};
const _hoisted_40 = { class: "magicflow-reason__track" };
const _hoisted_41 = {
  key: 1,
  class: "magicflow-table-empty"
};
const _hoisted_42 = { class: "magicflow-panel__head" };
const _hoisted_43 = { class: "magicflow-events" };
const _hoisted_44 = {
  key: 0,
  class: "text-error"
};
...
const _hoisted_46 = { class: "magicflow-diagnostic-head" };
const _hoisted_47 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_48 = { class: "magicflow-torrent-filters" };
const _hoisted_49 = { class: "magicflow-pipeline" };
const _hoisted_50 = { class: "magicflow-pipeline__index" };
const _hoisted_51 = { key: 0 };
const _hoisted_52 = { class: "magicflow-panel__head" };
const _hoisted_53 = { class: "magicflow-panel__title-row" };
const _hoisted_54 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_55 = { class: "magicflow-torrent-filters" };
const _hoisted_56 = { class: "torrent-title-cell" };
const _hoisted_57 = { class: "magicflow-mobile-torrents" };
const _hoisted_58 = ["onClick"];
const _hoisted_59 = { class: "magicflow-mobile-torrent__head" };
const _hoisted_60 = { class: "magicflow-mobile-torrent__title" };
const _hoisted_61 = { class: "magicflow-mobile-torrent__grid" };
const _hoisted_62 = { class: "magicflow-mobile-torrent__actions" };
const _hoisted_63 = {
  key: 0,
  class: "magicflow-table-empty"
};
const _hoisted_64 = { class: "magicflow-config-grid" };
const _hoisted_65 = { class: "magicflow-facts magicflow-facts--two" };
const _hoisted_66 = { class: "magicflow-config-actions" };
const _hoisted_67 = { class: "magicflow-facts magicflow-torrent-detail" };
const _hoisted_68 = { class: "text-caption text-medium-emphasis magicflow-hash-line" };
      ...
      : (!tasks.value.length)
        ...
        : (_openBlock(), _createElementBlock(_Fragment, { key: 4 }, [
            _createElementVNode("div", _hoisted_8, [
              (tasks.value.length > 1)
                ...
                : (_openBlock(), _createElementBlock("div", _hoisted_9, [
                    _cache[27] || (_cache[27] = _createElementVNode("span", null, "当前任务", -1)),
            ...
            _createElementVNode("div", _hoisted_10, [
              _createVNode(_component_VSheet, {
                ...
                default: _withCtx(() => [
                  _createElementVNode("div", _hoisted_11, [
                    _cache[29] || (_cache[29] = _createElementVNode("span", { class: "text-subtitle-2" }, "魔力任务", -1)),
              ...
              (selectedTask.value)
                ? (_openBlock(), _createElementBlock("main", _hoisted_16, [
                    ...
                    _createElementVNode("div", _hoisted_23, [
                      (_openBlock(), _createElementBlock(_Fragment, null, _renderList(MF_TABS, (tab) => {
                        ...
                        }, _toDisplayString(tab.label), 11, _hoisted_24)
                      }), 64))
                    ]),
                            ...
                            _createElementVNode("div", _hoisted_25, [
                              ...
                              _createVNode(_component_VSheet, { class: "magicflow-stat app-surface-static" }, {
                                default: _withCtx(() => [
                                  ...
                                  _cache[31] || (_cache[31] = _createElementVNode("span", null, "站点上报时魔 · 站点实时值", -1))
                                ]),
                                _: 1
                              }),
                              _createVNode(_component_VSheet, { class: "magicflow-stat app-surface-static" }, {
                              ...
                              _createVNode(_component_VSheet, {
                                ...
                                default: _withCtx(() => [
                                  ...
                                  _createElementVNode("dl", _hoisted_28, [
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[38] || (_cache[38] = _createElementVNode("dt", null, "最多保留", -1)),
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[39] || (_cache[39] = _createElementVNode("dt", null, "保护阈值", -1)),
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[43] || (_cache[43] = _createElementVNode("dt", null, "自动恢复暂停", -1)),
                              ...
                              _createVNode(_component_VSheet, {
                                ...
                                default: _withCtx(() => [
                                  _createElementVNode("header", _hoisted_29, [
                                    _createElementVNode("div", null, [
                                      _cache[46] || (_cache[46] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "最近一次运行", -1)),
                                      _createElementVNode("div", _hoisted_30, _toDisplayString(detailStats.value.last_run_at ? _unref(formatDateTime)(detailStats.value.last_run_at) : '暂无运行记录'), 1)
                                    ]),
                                  ...
                                  _createElementVNode("div", _hoisted_31, [
                                    _createElementVNode("div", null, [
                                      _cache[49] || (_cache[49] = _createElementVNode("span", null, "上次成功", -1)),
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[53] || (_cache[53] = _createElementVNode("span", null, "本次删除", -1)),
                                      _createElementVNode("strong", null, _toDisplayString(detailStats.value.last_deleted || 0), 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[54] || (_cache[54] = _createElementVNode("span", null, "当前托管 / 受保护", -1)),
                        ...
                        _createVNode(_component_VWindowItem, { value: "diagnostics" }, {
                          default: _withCtx(() => [
                            _createVNode(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                _createElementVNode("header", _hoisted_32, [
                                  _createElementVNode("div", null, [
                                    _cache[56] || (_cache[56] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "运行流程", -1)),
                                    _createElementVNode("div", _hoisted_33, _toDisplayString(detailStats.value.run_active ? '正在执行本轮刷流…' : (detailStats.value.last_run_at ? `最近执行 ${_unref(formatDateTime)(detailStats.value.last_run_at)}` : '尚未运行')) + " · 翻页游标 " + _toDisplayString(detailStats.value.page_cursor ?? 0), 1)
                                  ]),
                                  _createElementVNode("span", {
                                    ...
                                    _cache[57] || (_cache[57] = _createElementVNode("i", null, null, -1)),
                                    _createTextVNode(" " + _toDisplayString(flowPhaseText.value), 1)
                                  ], 2)
                                ]),
                                _createElementVNode("ol", _hoisted_34, [
                                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(flowNodes.value, (node, i) => {
                                    return (_openBlock(), _createElementBlock("li", {
                                      ...
                                      _createElementVNode("span", _hoisted_36, _toDisplayString(node.label), 1),
                            ...
                            _createVNode(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                _createElementVNode("header", _hoisted_37, [
                                  _createElementVNode("div", null, [
                                    _cache[58] || (_cache[58] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "过滤原因", -1)),
                                ...
                                (reasonEntries.value.length)
                                  ...
                                  : (_openBlock(), _createElementBlock("div", _hoisted_41, "本轮没有记录过滤原因（候选全部通过或列表为空）")),
                            ...
                            _createVNode(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                _createElementVNode("header", _hoisted_42, [
                                    ...
                                    return (_openBlock(), _createElementBlock("article", {
                                      ...
                                      _createElementVNode("div", null, [
                                        ...
                                        (record.error_message)
                                          ? (_openBlock(), _createElementBlock("span", _hoisted_44, _toDisplayString(record.error_message), 1))
                                          : _createCommentVNode("", true)
                                      ])
                                    ]))
                                  }), 128)),
                                  (!(operationData.value.operations || []).length)
                                    ? (_openBlock(), _createElementBlock("div", _hoisted_45, "暂无操作记录"))
                                    : _createCommentVNode("", true)
                                ])
                              ]),
                              _: 1
                        ...
                        _createVNode(_component_VWindowItem, { value: "pool" }, {
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_46, [
                              _createElementVNode("div", null, [
                                _cache[61] || (_cache[61] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "种子池", -1)),
                            ...
                            (poolView.value === 'candidates')
                              ? (_openBlock(), _createBlock(_component_VSheet, {
                                  ...
                                  default: _withCtx(() => [
                                    _cache[64] || (_cache[64] = _createElementVNode("header", { class: "magicflow-panel__head" }, [
                                      _createElementVNode("div", null, [
                                    ...
                                    _createElementVNode("ol", _hoisted_49, [
                                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList((candidateData.value.candidates || []).slice(0, 8), (candidate) => {
                                        return (_openBlock(), _createElementBlock("li", {
                                          ...
                                          _createElementVNode("span", _hoisted_50, _toDisplayString(candidate.rank), 1),
                                          _createElementVNode("div", null, [
                                      ...
                                      (!(candidateData.value.candidates || []).length)
                                        ? (_openBlock(), _createElementBlock("li", _hoisted_51, [...(_cache[63] || (_cache[63] = [
                              ...
                              : (_openBlock(), _createBlock(_component_VSheet, {
                                  ...
                                  default: _withCtx(() => [
                                    _createElementVNode("header", _hoisted_52, [
                                      _createElementVNode("div", null, [
                                        _createElementVNode("div", _hoisted_53, [
                                          _cache[65] || (_cache[65] = _createElementVNode("span", { class: "text-subtitle-1 font-weight-medium" }, "托管种子", -1)),
                                          _createVNode(_component_VChip, {
                                            size: "x-small",
                                            variant: "tonal"
                                          }, {
                                        ...
                                        _createElementVNode("div", _hoisted_54, " 共 " + _toDisplayString(bonusData.value.torrent_count || 0) + " 个 · 点击任意行查看详情 / 手动保留 / 删除 ", 1)
                                      ]),
                                    ...
                                    _createVNode(_component_VDataTable, {
                                      ...
                                      "no-data": _withCtx(() => [...(_cache[68] || (_cache[68] = [
                                    ...
                                    _createElementVNode("div", _hoisted_57, [
                                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sortedTorrents.value, (item) => {
                                        return (_openBlock(), _createElementBlock("article", {
                                          ...
                                          _createElementVNode("div", _hoisted_61, [
                                            _createElementVNode("span", null, [
                                              _cache[69] || (_cache[69] = _createElementVNode("em", null, "大小", -1)),
                                              _createElementVNode("b", null, _toDisplayString(Number(item.size_gb || 0).toFixed(2)) + " GB", 1)
                                            ]),
                                            _createElementVNode("span", null, [
                                              _cache[70] || (_cache[70] = _createElementVNode("em", null, "上传量", -1)),
                                              _createElementVNode("b", null, _toDisplayString(_unref(formatBytes)(item.uploaded)), 1)
                                            ]),
                                            _createElementVNode("span", null, [
                                              _cache[71] || (_cache[71] = _createElementVNode("em", null, "分享率", -1)),
                                      ...
                                      (!sortedTorrents.value.length)
                                        ? (_openBlock(), _createElementBlock("div", _hoisted_63, "当前筛选下没有托管种子"))
                                        : _createCommentVNode("", true)
                                    ])
                                  ]),
                                  _: 1
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_64, [
                              _createVNode(_component_VSheet, {
                                ...
                                default: _withCtx(() => [
                                  _cache[101] || (_cache[101] = _createElementVNode("header", { class: "magicflow-panel__head" }, [
                                    _createElementVNode("div", null, [
                                  ...
                                  _createElementVNode("dl", _hoisted_65, [
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[88] || (_cache[88] = _createElementVNode("dt", null, "单轮最多新增", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.max_add_per_run ?? 10) + " 个", 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[89] || (_cache[89] = _createElementVNode("dt", null, "同时下载上限", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.max_download_concurrent ?? 10) + " 个", 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[90] || (_cache[90] = _createElementVNode("dt", null, "每轮参评候选", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.top_n ?? 30) + " 个", 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[91] || (_cache[91] = _createElementVNode("dt", null, "每轮翻页数", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.browse_pages ?? 3) + " 页", 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[92] || (_cache[92] = _createElementVNode("dt", null, "保护阈值", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.bonus_protect_threshold == null ? '站点当前魔力' : Number(taskConfig.value.bonus_protect_threshold).toFixed(0)), 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[93] || (_cache[93] = _createElementVNode("dt", null, "自动补种", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.refill_when_empty ? '开启' : '关闭'), 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[94] || (_cache[94] = _createElementVNode("dt", null, "存量复用", -1)),
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[95] || (_cache[95] = _createElementVNode("dt", null, "无进度清理", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.cleanup_no_progress ? `开启（${taskConfig.value.no_progress_minutes ?? 30} 分钟）` : '关闭'), 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[96] || (_cache[96] = _createElementVNode("dt", null, "自动恢复暂停", -1)),
                                      _createElementVNode("dd", null, _toDisplayString(taskConfig.value.auto_resume_paused === false ? '关闭' : '开启'), 1)
                                    ]),
                                    _createElementVNode("div", null, [
                                      _cache[97] || (_cache[97] = _createElementVNode("dt", null, "公式 T0/N0", -1)),
                              ...
                              _createVNode(_component_VSheet, {
                                ...
                                default: _withCtx(() => [
                                  _cache[111] || (_cache[111] = _createElementVNode("header", { class: "magicflow-panel__head" }, [
                                    _createElementVNode("div", null, [
                                  ...
                                  _createElementVNode("div", _hoisted_66, [
                                    _createElementVNode("div", null, [
                                      _cache[103] || (_cache[103] = _createElementVNode("strong", null, "执行一次", -1)),
                                      _cache[104] || (_cache[104] = _createElementVNode("span", null, "立即按当前策略抓取候选并养护做种", -1)),
                                      _createVNode(_component_VBtn, {
                                        color: "primary",
                                        variant: "tonal",
                                    ...
                                    _createElementVNode("div", null, [
                                      _cache[106] || (_cache[106] = _createElementVNode("strong", null, "编辑任务", -1)),
                                      _cache[107] || (_cache[107] = _createElementVNode("span", null, "调整调度、魔力门槛与公式参数", -1)),
                                      _createVNode(_component_VBtn, {
                                        variant: "tonal",
                                    ...
                                    _createVNode(_component_VDivider),
                                    _createElementVNode("div", null, [
                                      _cache[109] || (_cache[109] = _createElementVNode("strong", null, "删除任务", -1)),
                                      _cache[110] || (_cache[110] = _createElementVNode("span", null, "存在活跃种子时后端会拒绝删除，避免留下失管任务", -1)),
                                      _createVNode(_component_VBtn, {
                                        color: "error",
                                        variant: "tonal",
                                        "prepend-icon": "mdi-delete-outline",
          ...
          ? (_openBlock(), _createBlock(_component_VCard, {
              ...
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    _createElementVNode("dl", _hoisted_67, [
                      _createElementVNode("div", null, [
                        _cache[112] || (_cache[112] = _createElementVNode("dt", null, "状态", -1)),
                      ...
                      _createElementVNode("div", null, [
                        _cache[113] || (_cache[113] = _createElementVNode("dt", null, "下载进度", -1)),
                        _createElementVNode("dd", null, _toDisplayString((Number(activeTorrent.value.progress || 0) * 100).toFixed(1)) + "%", 1)
                      ]),
                      _createElementVNode("div", null, [
                        _cache[114] || (_cache[114] = _createElementVNode("dt", null, "大小", -1)),
                      ...
                      _createElementVNode("div", null, [
                        _cache[117] || (_cache[117] = _createElementVNode("dt", null, "手动保留", -1)),
                        _createElementVNode("dd", null, _toDisplayString(activeTorrent.value.is_protected ? '已保护' : '未保护'), 1)
                      ])
                    ]),
                    _createElementVNode("div", _hoisted_68, "infohash：" + _toDisplayString(activeTorrent.value.hash), 1)
                  ]),
                  _: 1
                }),
                _createVNode(_component_VCardActions, null, {
...
const MagicFlowWorkbench = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-8d6dcc6b"]]);
